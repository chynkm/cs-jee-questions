...
function imageUrlForPDF($fileName) {
...
if($questions != array()) {
    ...
    $origQuestion = $question['question_type'] == 'text' ? $question['question'] : imageUrlForPDF($question['question']);

    $optionA = $question['option_a_type'] == 'text' ? $question['option_a'] : imageUrlForPDF($question['option_a']);
    $optionB = $question['option_b_type'] == 'text' ? $question['option_b'] : imageUrlForPDF($question['option_b']);
    $optionC = $question['option_c_type'] == 'text' ? $question['option_c'] : imageUrlForPDF($question['option_c']);
    $optionD = $question['option_d_type'] == 'text' ? $question['option_d'] : imageUrlForPDF($question['option_d']);
